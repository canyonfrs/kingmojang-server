...
class ReplyService(
    ...
    fun updateReply(replyId: Long, memberId: Long, request: ReplyRequest): Long {
        val reply = replyRepository.findReplyWithWriterByIdAndDeletedFalse(replyId)
                ?: throw NotFoundReplyException(replyId)
    ...
    fun deleteReply(replyId: Long, memberId: Long) {
        ...
        replyLikeRepository.deleteAllInBatch(replyLikeRepository.findAllByReplyId(replyId))
    }
