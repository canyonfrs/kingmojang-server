...
class AuthController(
    ...
    @PostMapping("/members")
    fun signup(@RequestBody  request: SignupRequest): ResponseEntity<CommonResponse<Void>> {
        ...
        return ResponseEntity.created(uri).body(CommonResponse.of(ResponseStatus.SUCCESS))
    }
